...
var ChallengeComponent = (function () {
    ...
    */
    ChallengeComponent.prototype.checkFailure = function (dateArray, today) {
    ...
    */
    ChallengeComponent.prototype.iterateCompassion = function () {
    ...
    */
    ChallengeComponent.prototype.revertSuccess = function () {
        var compassionNum = this.checkCompassion();
    ...
    */
    ChallengeComponent.prototype.checkCompassion = function () {
     ...
     */
    ChallengeComponent.prototype.intCompassion = function () {
        var compassionNum = this.checkCompassion();
     ...
     */
    ChallengeComponent.prototype.compassionPhrases = function (num) {
        localStorage.setItem("compassionMsg", "shown");
        $(".thankyou").hide(); // by default hide
        if ($(".compassionDay").attr('firstCompassion') == 'true' || localStorage.getItem("compassionIteration") == "true") {
    ...
    */
    ChallengeComponent.prototype.startCompassion = function () {
        if (confirm('Compassion Challenge challenges you to record 5 kindnesses in 5 days')) {
            // start compassion challenge
            $(".compassion-radio").toggleClass("compassion-radio--clicked");
            localStorage.setItem("compassionIteration", 'true');
    ...
    */
    ChallengeComponent.prototype.stopCompassion = function () {
