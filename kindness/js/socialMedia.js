 ...
 */ 
   ...
   function facebookShare(type){ 
      ...
      if(type == 'finished'){
        var msg = 'I finished the 10 day compassion challenge! That\'s 10 acts of kindness in 10 days! Try it now';
      }
      else{
...
/*
      FB.ui({
        ...
        method: 'share',
        mobile_iframe: true,
        href: 'http://mrmoonhead.com/kindness',
      }, function(response){});
*/
	  
	window.plugins.socialsharing.shareViaFacebook( msg , 'img/icons/heart.png' /* img */, 'http://mrmoonhead.com'  /* url */,
 ...
 */ 
 function twitter(type){
   jQuery('#sonnyGif').attr('onclick', 'analytics("twitter_share")').click();
    ...
    var url = 'http%3A%2F%2Fmrmoonhead.com%2Fkindness';
